...
const Signup = ({ navigation }) => {
    ...
    const handleSubmit = async () => {
        if (validate()) {
            try {
                const response = await fetch('https://code123.pythonanywhere.com/signup/', {
                    method: 'POST',
                    headers: {
                ...
                if (response.ok) {
                    ...
                    Alert.alert('Error', result.message || 'An error occurred during sign up.');
                }
            } catch (error) {
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
            <View style={{ flex: 1, marginHorizontal: 22 }}>
                ...
                <View style={{ flexDirection: 'row', marginVertical: 6 }}>
                    ...
                    />
                    <Text style={{ marginLeft: 8, color: 'black' }}>I agree to the terms and conditions</Text>
                </View>
